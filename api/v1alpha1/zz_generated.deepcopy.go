...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ODGChart) DeepCopyInto(out *ODGChart) {
	*out = *in
	if in.ChartURL != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ODGChart.
func (in *ODGChart) DeepCopy() *ODGChart {
	if in == nil {
		return nil
	}
	out := new(ODGChart)
